...
<div class="row pl-md-5 pt-5">
    <div class="col pl-5 pr-5">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="#">Colecciones</a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="#" data-toggle="modal" data-target="#modalCrearColeccion">
            ...
            @foreach($colecciones as $coleccion)
               <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                        <form class="mb-0 mr-1" action="{{url('operador/colecciones')}}" method="post">
                            @csrf
                        ...
                        <a href="{{url('operador/coleccion/'.$coleccion->id)}}" class="btn btn-success mr-1">
                        ...
                        <a href="{{url('operador/agregar/coleccion/'.$coleccion->id)}}" class="btn btn-success">
...
@endsection
@include('layouts.partials.modalCrearColeccion',['url' => "operador/colecciones"])