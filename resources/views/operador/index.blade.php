                    ...
                    <div class="card" style="width: 18rem; ">
                        ...
                        <div class="card-body">
                            ...
                            @if($fotos->estatu_id==2)
                                <form class="d-inline" action="{{url('/operador/fotografia/publicar')}}" method="POST">
                                    @csrf
                            ...
                            @endif
                            <form class="d-inline" action="{{url('/operador/fotografia/eliminar')}}" method="POST">
                                @csrf
...
@include('layouts.partials.modalCrear',["url"=>'operador/fotografia'])
@endsection