...
<div class="row pl-md-5 pt-5">
    <div class="col pl-5 pr-5">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="#">Estatus</a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="#" data-toggle="modal" data-target="#modalcrearEstatus">
            ...
            <tbody>
               ...
               <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <form action="{{url('admin/estatus')}}" method="post">
                            @csrf
                            <input type="hidden" name="_method" value="delete" />
                            <input type="hidden" name="id" value="{{$estatu->id}}">
...
@include('layouts.partials.modalCrearEstatus')
@endsection