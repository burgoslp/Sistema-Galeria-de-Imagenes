...
<div class="row pl-md-5 pt-5">
    <div class="col pl-5 pr-5">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" href="#">Generos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="#" data-toggle="modal" data-target="#modalcrearGeneros">
            ...
            <tbody>
               ...
               <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <form action="{{url('admin/generos')}}" method="post">
                            @csrf
...
@include('layouts.partials.modalCrearGenero')
@endsection