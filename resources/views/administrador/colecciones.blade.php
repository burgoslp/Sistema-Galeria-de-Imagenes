            ...
            @foreach($colecciones as $coleccion)
               <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{url('admin/coleccion/'.$coleccion->id)}}" class="btn btn-success mr-1">
                        ...
                        <a href="{{url('admin/agregar/coleccion/'.$coleccion->id)}}" class="btn btn-success">
...
@endsection
@include('layouts.partials.modalCrearColeccion',['url' => "admin/colecciones"])